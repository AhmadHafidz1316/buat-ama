    ...
    <div class="row d-flex align-items-center bg-success bg-opacity-50 p-4 rounded shadow-lg">
        ...
        <div class="col-md-8 text-white">
            ...
            <div class="col-md-4 icon mt-3 text-center">
                <p class="fs-5 col-md-10"><i class="far fa-clock fa-lg"></i> Jum'at | 18.00 - 20.00</p>
                <p class="fs-5 col-md-11"><i class="far fa-user fa-lg"></i> Laki-laki dan Perempuan</p>
            </div>
        </div>
    </div>
</div>
